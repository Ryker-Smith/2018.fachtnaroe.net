...
function newDraggable (elementParent, elementId, w, h, im) {
  ...
  newDiv.style.cssText="position:absolute;background-color:transparent; -webkit-user-select:none; -moz-user-select:none; -o-user-select:none; -ms-user-select:none; -khtml-user-select:none; user-select:none;";
  ...
  newDiv_inner.style.cssText="width:" + w + "px;height:" + h + "px;background-color:transparent;  padding:10px;";
